      ...
      <header className="bg-[#123e7f] text-white p-4 shadow-md">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <div>
            ...
            <p className="text-sm opacity-80">Zeiten einsehen & bearbeiten</p>
          </div>
      ...
      <main className="max-w-6xl mx-auto p-4 py-8">
        <div className="flex justify-between items-center mb-6">
          <input 
            ...
            className="p-2 border border-gray-300 rounded text-black font-medium focus:ring-2 focus:ring-[#ed8022] outline-none"
          />
