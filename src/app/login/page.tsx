    ...
    <div className="flex min-h-[80vh] items-center justify-center p-4 bg-[#f5f8ff]">
      <div className="w-full max-w-md bg-white p-8 rounded-xl shadow-md border-t-4 border-[#ed8022]">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-800 mt-2">Login to your timesheet</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full p-2 border border-gray-300 rounded-md text-black focus:outline-none focus:ring-2 focus:ring-[#ed8022]"
            />
          </div>
          <button
            type="submit"
